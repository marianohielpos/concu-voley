...
void Publicador::run() {
    this->logger_->info("[Publicador] Publicador incializado");
    ...
    while(sigint_handler.getGracefulQuit() == 0){
        ...
        this->logger_->info("[Publicador] Publicador hace update...");
        this->publicadorEstadisticas_.update();
    }

    SignalHandler::destruir();
    this->logger_->info("[Publicador] Proceso de publicador termina");
